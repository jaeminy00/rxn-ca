...
from ..reactions.scorers.core import TammanHuttigScoreErf, TammanHuttigScoreExponential, TammanHuttigScoreSoftplus, GibbsErfScore, TammanScore
...
class ScoreTypes(str, Enum):
    ...
    GIBBS_ERF_SCORE = "GIBBS_ERF_SCORE"
...
_SCORE_TYPE_MAP = {
    ...
    ScoreTypes.GIBBS_ERF_SCORE: GibbsErfScore,
    ScoreTypes.TAMMAN: TammanScore
}
